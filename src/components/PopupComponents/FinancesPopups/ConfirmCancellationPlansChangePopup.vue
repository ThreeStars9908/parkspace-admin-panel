    ...
    <div className="w-[766px] h-[140px] bg-white
      ...
      <div className="flex flex-row justify-between">
        <div className="font-semibold text-[16px]">
          Confirm cancellation plans?
        </div>
        <div className="cursor-pointer"
             @click="this.$emit('confirmCancellationChange', false)">
          <v-icon name="io-close" />
        </div>
      </div>
      <div className="flex flex-row justify-between">
        <div className="w-[241px] p-[12.5px] border-[#008AB6]
              border-2 text-[#008AB6] rounded-[8px] cursor-pointer
...
<script>
export default {
  name: 'ConfirmCancellationPlansChangePopup',
  data() {
    return {};
  },
  methods: {},
